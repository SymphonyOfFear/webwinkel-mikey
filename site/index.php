                    ...
                    <nav class="navbar">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ml-auto py-4 py-md-0">
                                <li class="nav-item pl-4 pl-md-0 ml-0 ml-0 ml-md-4 active">
                                ...
                                <li class="nav-item pl-4 pl-md-0 ml-0 ml-md-4">
                                    <a class="nav-link" href="#">Bedrijf</a>
                                </li>
                                <li class="nav-item pl-4 pl-md-0 ml-0 ml-md-4">
                                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Services</a>
                                    <div class="dropdown-menu">
                                      <a class="dropdown-item" href="#">Nieuw</a>
                                      <a class="dropdown-item" href="#">Desktops</a>
                                      <a class="dropdown-item" href="#">Laptops</a>
                                      <a class="dropdown-item" href="#">Gaming Pc's</a>
                                    </div>
                                </li>
                                <li class="nav-item pl-4 pl-md-0 ml-0 ml-md-4">
                                  ...
                                  <li class="nav-item pl-4 pl-md-0 ml-0 ml-md-4">
                                    <a class="nav-link" href="#">Neem contact op met ons!</a>
                                  </li>
                            </ul>
                        </div>
                    </nav>
